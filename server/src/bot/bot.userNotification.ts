...
Напоминаем, что <b>ваша подписка на канал JUMPING UNIVERSE истекла</b>, и сегодня ваш аккаунт будет <b>исключен</b>⏳

Чтобы <b>оставаться с нами</b>, выбирайте нужную кнопку ниже и оплачивайте продление🔥
Если вы из России, оплата возможна только картой платежной системы «Мир»`;
    //     const text = `Здравствуйте, ${user.firstName}!
